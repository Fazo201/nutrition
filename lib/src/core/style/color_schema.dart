...
const ColorScheme lightColorScheme = ColorScheme(
  ...
  primary: Color.fromRGBO(18, 149, 117, 1),

  ///129575 For main components on UI!
  onPrimary: Color(0xFFFFFFFF),

  ///FFFFFF For items ex. icons, texts on main components on UI!
  primaryContainer: Color.fromRGBO(219, 235, 231, 1),
  primaryFixedDim: Color(0xFF71B1A1),
  ...
  ///FFFFFF For backgrounds of (Scaffold, app, ...).
  surfaceDim: Color(0xFF000000),

  ///000000 Always darkest at the dark and light mode!
  onSurface: Color.fromRGBO(18, 18, 18, 1),

  ///121212 For items on background!
  surfaceBright: Color.fromRGBO(217, 217, 217, 1),
  ...
  /// When components take up like popups or dropdowns!
  shadow: Color.fromRGBO(105, 105, 105, 0.1),
...
const ColorScheme darkColorScheme = ColorScheme(
  ...
  ///2ec866 For main components on UI!
  onPrimary: Color(0xFF121418),

  ///121418 For items ex. icons, texts on main components on UI!
  primaryContainer: Color(0xFF008175),
  primaryFixedDim: Color(0xFF00be3a),
  primaryFixed: Color(0xFF009851),
  ...
  ///121418 For backgrounds of (Scaffold, app, ...).
